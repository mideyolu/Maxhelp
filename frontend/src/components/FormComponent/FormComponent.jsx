    ...
    return (
        <Card color="transparent" shadow={false}>
            ...
            >
                    ...
                    {fields.map((field, index) => (
                        <div key={index}>
                            ...
                            <Input
                                ...
                                className="!border-t-blue-gray-200 focus:mt-1 focus:!border-t-gray-900"
                                labelProps={{
                                    className:
                ...
                >
                    {
                        loading ? <Spinner className="flex items-center justify-center mx-auto"/> : submitButtonText
                    }
                </Button>
            </form>
