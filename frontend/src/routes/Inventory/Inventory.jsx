    ...
    useEffect(() => {
        ...
        const getInventoryStats = async () => {
            try {
                ...
                toast.error(
                    "Failed to fetch inventory stats. Please try again.",
                );
            } finally {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-[2rem]">
                    <Card className="h-full w-full shadow-none relative">
                        <div className="flex items-center justify-between">
                            ...
                            {role === "employee" && (
                                <div className="right absolute right-[-15%] md:right-[-50%]">
                                    <div className="flex justify-end mb-6">
                                        <Button
                                            onClick={() =>
                                                setShowLowInventoryForm(true)
                                            }
                                            color="blue"
                                            className="mb-4"
                                        >
                        ...
                        {showLowInventoryForm && (
                            <LowInventory
                                ...
                                onSuccess={() =>
                                    toast.success(
                                        "Low inventory reported successfully",
                                    )
                                }
                                onError={() =>
                                    toast.error(
                                        "Failed to report low inventory",
                                    )
                                }
                            />
                        )}
